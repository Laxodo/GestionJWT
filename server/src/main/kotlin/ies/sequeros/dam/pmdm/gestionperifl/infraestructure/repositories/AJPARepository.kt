...
abstract class AJPARepository<T>(protected open val emf: EntityManagerFactory,protected open val tableName: String="") {
    ...
    protected fun <R> executeQueryWithCache(
        ...
        // Caffeine intentará obtener el valor, si no existe, ejecutará executeQuery
        return cache.get(key, Function { k: String? -> executeQuery<R?>(action, operation) }) as R?
    }
